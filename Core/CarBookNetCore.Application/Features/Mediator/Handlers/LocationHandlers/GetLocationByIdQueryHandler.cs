...
using CarBookNetCore.Application.Features.Mediator.Results.LocationResults;
...
namespace CarBookNetCore.Application.Features.Mediator.Handlers.LocationHandlers
{
