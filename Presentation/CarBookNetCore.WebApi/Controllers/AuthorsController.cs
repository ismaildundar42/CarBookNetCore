using CarBookNetCore.Application.Features.Mediator.Commands.AuthorCommands;
...
namespace CarBookNetCore.WebApi.Controllers
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        public async Task<IActionResult> RemoveAuthor(int id)
        {
            ...
            return Ok("Author başarılı bir şekilde silindi!");
        }
        [HttpPut]
        public async Task<IActionResult> UpdateAuthor(UpdateAuthorCommand command)
        {
            await _mediator.Send(command);
            return Ok("Author başarılı bir şekilde güncellendi!");
        }
    }
}
