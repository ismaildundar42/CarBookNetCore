...
namespace CarBookNetCore.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        [HttpGet("GetCarCountByKmSmallerThan50k")]
        public async Task<IActionResult> GetCarCountByKmSmallerThan50k()
        {
            var value = await _mediator.Send(new GetCarCountByKmSmallerThan50kQuery());
            return Ok(value);
        }
