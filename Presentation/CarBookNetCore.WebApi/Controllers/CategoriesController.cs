...
using CarBookNetCore.Application.Features.CQRS.Commands.CategoryCommdans;
...
namespace CarBookNetCore.WebApi.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateCategory(CreateCategoryCommand command)
        {
            ...
            return Ok("Category bilgisi başarılı bir şekilde eklendi!");
        }
        [HttpDelete]
        public async Task<IActionResult> RemoveCategory(int id)
        {
            await _removeCategoryCommandHandler.Handle(new RemoveCategoryCommand(id));
            return Ok("Category bilgisi başarılı bir şekilde silindi!");
        }
        [HttpPut]
        public async Task<IActionResult> UpdateCategory(UpdateCategoryCommand command)
        {
            await _updateCategoryCommandHandler.Handle(command);
            return Ok("Category bilgisi başarılı bir şekilde güncellendi!");
        }
    }
}
