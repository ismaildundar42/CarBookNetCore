...
namespace CarBookNetCore.WebApi.Controllers
{
    ...
    public class ContactsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateContact(CreateContactCommand command)
        {
            ...
            return Ok("Contact bilgisi başarılı bir şekilde eklendi!");
        }
        [HttpDelete]
        public async Task<IActionResult> RemoveContact(int id)
        {
            await _removeContactCommandHandler.Handle(new RemoveContactCommand(id));
            return Ok("Contact bilgisi başarılı bir şekilde silindi!");
        }
        [HttpPut]
        public async Task<IActionResult> UpdateContact(UpdateContactCommand command)
        {
            await _updateContactCommandHandler.Handle(command);
            return Ok("Contact bilgisi başarılı bir şekilde güncellendi!");
        }
    }
}
