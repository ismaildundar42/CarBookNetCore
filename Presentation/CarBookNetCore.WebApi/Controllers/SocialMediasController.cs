using CarBookNetCore.Application.Features.Mediator.Commands.SocialMediaCommands;
...
namespace CarBookNetCore.WebApi.Controllers
{
    ...
    public class SocialMediasController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateSocialMedia(CreateSocialMediaCommand command)
        {
            ...
            return Ok("SocialMedia başarılı bir şekilde eklenmiştir!");
        }
        [HttpDelete]
        public async Task<IActionResult> RemoveSocialMedia(int id)
        {
            await _mediator.Send(new RemoveSocialMediaCommand(id));
            return Ok("SocialMedia başarılı bir şekilde silindi!");
        }
        [HttpPut]
